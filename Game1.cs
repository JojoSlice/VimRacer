...
public sealed class Game1 : Game
{
    ...
    private void ExecuteCommand()
    {
        ...
        else if (_command == ":friends")
            _scenes.Transition(new FriendScene(_scenes, this, _network));
        ...
        else if (_scenes.CurrentScene is FriendScene friends)
            friends.HandleCommand(_command);
